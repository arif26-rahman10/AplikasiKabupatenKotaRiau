package arifrahman.polbeng.ac.id.kabupatenkotariauapp

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import arifrahman.polbeng.ac.id.kabupatenkotariauapp.databinding.ItemListKabkotaBinding
...
class ListKabKotaAdapter(private val listKabKota: ArrayList<KabKota>):
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { onItemClickCallback.onItemClicked(listKabKota[holder.adapterPosition]) }
    }
